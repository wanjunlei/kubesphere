...
func NewResourceGetter(factory informers.InformerFactory, cache cache.Cache) *ResourceGetter {
	...
	getters[notificationv2beta1.SchemeGroupVersion.WithResource(v2beta1.ResourcesPluralConfig)] = notification.NewNotificationConfigGetter(factory.KubeSphereSharedInformerFactory())
	getters[notificationv2beta1.SchemeGroupVersion.WithResource(v2beta1.ResourcesPluralReceiver)] = notification.NewNotificationReceiverGetter(factory.KubeSphereSharedInformerFactory())
